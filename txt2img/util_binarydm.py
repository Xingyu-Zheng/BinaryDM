    ...
    def forward(self, x, bnn_mode='bnn'):
        ...
        if not self.init_scale:
            ...
            try:
                ...
                self.scaling_second_order = nn.Parameter(torch.rand(self.out_channels, 1, 1, 1) * 0.001, requires_grad=True)
                self.scaling_second_order.data = scaling_factor
    ...
    def forward(self, x, bnn_mode='bnn'):
        ...
        if not self.init_scale:
            ...
            try:
                ...
                self.scaling_second_order = nn.Parameter(torch.rand(self.out_channels, 1, 1) * 0.001, requires_grad=True)
                self.scaling_second_order.data = scaling_factor
            self.init_scale = True
    ...
    def forward(self, input, bnn_mode='bnn'):
        ...
        if not self.init_scale:
            ...
            try:
                ...
                self.scaling_second_order = nn.Parameter(torch.rand(self.out_features, 1) * 0.001, requires_grad=True)
                self.scaling_second_order.data = scaling_factor
            self.init_scale = True

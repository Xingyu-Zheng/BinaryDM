...
class QKVAttentionLegacy(nn.Module):
    ...
    def __init__(self, n_heads):
        ...
        self.act_quantizer_q = _ActQ()
        self.act_quantizer_k = _ActQ()
        self.act_quantizer_w = _ActQ()
        self.act_quantizer_v = _ActQ()
    ...
    def forward(self, qkv):
        ...
        if self.binary_act:
            ...
            weight = th.einsum(
                "bct,bcs->bts", self.act_quantizer_q(q * scale), self.act_quantizer_k(k * scale)
        ...
        for name, module in self.named_modules():
            ...
            if isinstance(module, BNNConv1d) or isinstance(module, BNNConv2d) or isinstance(module, BNNLinear):
                ...
                if 'middle' in name:
                    ...
                    self.emb_out_group.append(module)
                self.bnn_modules.append(module)
